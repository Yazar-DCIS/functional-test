...
public class CrimeDetails extends BaseTag {
	...
	public CrimeDetails informationRelatedToCrime(String appname,
			String elementProperty, String anyCrimes) {

		PropertyResource propertyFile = new PropertyResource();
		Properties appName = propertyFile.loadProperty(appname);

		YesNo crimeDone = new YesNo(driver, String.format(crime,
				elementProperty));
	...
	public CrimeDetails informationRelatedOathWithExplaination(String appname,
			String elementProperty, String answer) {

		PropertyResource propertyFile = new PropertyResource();
		Properties appName = propertyFile.loadProperty(appname);

		YesNo answerYesOrNo = new YesNo(driver, String.format(crime,
				elementProperty));
	...
	public CrimeDetails informationOnCrimeWithoutExplain(
			String elementProperty, String anyCrimes) {

		YesNo crimeDone = new YesNo(driver, String.format(crimeInfo,
				elementProperty));

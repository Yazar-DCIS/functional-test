...
public class PhysicalTraits extends BaseTag {
	...
	protected String heightOptionExpression = "%s.heightoption";
	protected List<WebElement> heightOptionButton;
	protected String weightOptionExpression = "%s.weightoption";
	protected List<WebElement> weightOptionButton;
	...
	public PhysicalTraits setOptionEnglish() {
		weightOptionButton = driver.findElements(By.name(String.format(
				weightOptionExpression, property)));
		weightOptionButton.get(0).click();
		return this;
	}
	...
	public PhysicalTraits setOptionMetric() {
		weightOptionButton = driver.findElements(By.name(String.format(
				weightOptionExpression, property)));
		weightOptionButton.get(1).click();
		return this;
	}
	...
	public PhysicalTraits setRaceOptions(String elementID, String raceType) {
		...
		for (String raceTypeSelect : raceValues.split(",")) {
			MultiRadioOptions race = new MultiRadioOptions(driver,
					"applicationData-" + elementID + ".raceList["
							+ raceTypeSelect + "].race");

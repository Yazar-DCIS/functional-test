...
public class MaritalInfo extends BaseTag {
	...
	public MaritalInfo setPlaceOfMarriage(String answer) {
		maritalInfo = driver.findElement(By.name(String.format(
				placeOfMarriageExpression, property)));
		maritalInfo.sendKeys(answer);
		return this;
	}

	public MaritalInfo setMarriageStatus(String answer) {
		maritalInfo = driver.findElement(By.id(String.format(
				maritalStatusExpression, property)));

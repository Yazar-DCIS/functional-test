 ...
 * 
 * @author Orina Author: <a href="mailto:hari@dcis.net">Hari Selvarajan</a>
 *         Date: 6/19/15 7:31 PM Revision: $Rev$
 */
public class Name_FirstMiddleLast extends BaseTag {
	...
	String inCareOfAgentNameFieldExpression = "%s-%s.inCareOfAgentName";
	String inCareOfNameExpression = "%s-%s.careOfName";
	WebElement inCareOfNameField;
	...
	public Name_FirstMiddleLast setInCareOfAgentName(String inCareOf) {
		inCareOfNameField = driver.findElement(By.id(String.format(
				inCareOfAgentNameFieldExpression, beanName, property)));
		inCareOfNameField.clear();
		inCareOfNameField.sendKeys(inCareOf);

		return this;
	}

	public Name_FirstMiddleLast setInCareOfName(String inCareOf) {
		inCareOfNameField = driver.findElement(By.id(String.format(
				inCareOfNameExpression, beanName, property)));
		inCareOfNameField.clear();
		inCareOfNameField.sendKeys(inCareOf);
	...
	public Name_FirstMiddleLast setApplicantNameDetails(String firstName,
			String lastName, String haveMiddleName, String middleName) {

...
public class Numbers extends BaseTag {
	...
	protected String certificateExpression = "%s";
	protected String certificateNumberUnknownExpression = "%sCheckbox";
	...
	protected WebElement numberUnknownField;
	...
	public Numbers setNumberUnknown() {
		numberUnknownField = driver.findElement(By.id(String.format(
				numberUnknownExpression, property)));
		numberUnknownField.click();
		return this;
	}

	public Numbers setNumberUnknownByElementName() {
		numberUnknownField = driver.findElement(By.name(String.format(
				numberUnknownExpression, property)));
		numberUnknownField.click();
		return this;
	}
	...
	public Numbers setnaturalizationCertificateNumber(String certificateNumber) {
		arnField = driver.findElement(By.id(String.format(
				certificateExpression, property)));
		arnField.sendKeys(certificateNumber);
		return this;
	}

	public Numbers setCertificateNumberUnknown() {
		numberUnknownField = driver.findElement(By.id(String.format(
				certificateNumberUnknownExpression, property)));
		numberUnknownField.click();
		return this;
	}

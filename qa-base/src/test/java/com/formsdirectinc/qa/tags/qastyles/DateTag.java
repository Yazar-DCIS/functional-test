...
/**
 * Date: Selenium page model for Date Tag Author: <a
 * href="mailto:hari@dcis.net">Hari Selvarajan</a> Date: 6/22/15 1:28 PM
 * 
...
public class DateTag extends BaseTag {
	...
	public DateTag setDate(String day, String month, String year) {
		selectDay(day);
		selectMonth(month);
		selectYear(year);
		return this;
	...
	public DateTag setStartYear(String fromYear) {
		fromDDMField = driver.findElement(By.name(String.format(fromExpression
				+ year, property)));
		fromDDMField.sendKeys(fromYear);
		return this;
	}
	...
	public DateTag setEndYear(String toYear) {
		toDDMField = driver.findElement(By.name(String.format(toExpression
				+ year, property)));
		toDDMField.sendKeys(toYear);
		return this;
	}

	public DateTag setFromDate(String fromDay, String fromMonth, String fromYear) {
		setStartDay(fromDay);
	...
	public DateTag setToDate(String toDay, String toMonth, String toYear) {
		setEndDay(toDay);
		setEndMonth(toMonth);
		setEndYear(toYear);
		return this;
	...
	public void calculateDate(String date, int monthCalculation,
			int dayCalculation, int yearCalculation) {
		...
		if (date.equalsIgnoreCase("future")) {
			...
			System.out
					.println("Month:::::" + month.format(dateLabel.getTime()));

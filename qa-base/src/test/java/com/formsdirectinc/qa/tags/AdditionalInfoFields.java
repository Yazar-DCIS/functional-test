...
public class AdditionalInfoFields extends BaseTag {
	...
	protected String numberExpression = "%s.number";
	protected String nameExpression = "%s.name";
	...
	public AdditionalInfoFields setNumber(String number) {
		naturalizationInformation = driver.findElement(By.name(String.format(
				numberExpression, property)));
		naturalizationInformation.clear();
		naturalizationInformation.sendKeys(number);
		return this;
	}

	public AdditionalInfoFields setName(String name) {
		naturalizationInformation = driver.findElement(By.name(String.format(
				nameExpression, property)));
		naturalizationInformation.sendKeys(name);
		return this;
	}
}
...
public class Address extends BaseTag {
	...
	protected String countryOtherTextExp = "%s.country-countryothertext";
	protected String countryOtherTextExpression = "%s-countryothertext";
	...
	protected String immigrantCity = "%s.cityLivedAsImmigrant";
	protected String visaIssuedCity = "%s.consulateVisaIssued";
	protected String adjustmentOfStatusCity = "%s.cityLivedAdjustmentOfStatus";
	protected String uscisOfficeCity = "%s.uscisOffice";
	protected WebElement streetTextField;
	protected String destinationCity = "%s.desitinationCity";
	protected String portOfEntryCity = "%s.portOfEntry.name";
	...
	public Address setRandomState(String state) {
		stateTextBoxField = driver.findElement(By.id(String.format(randomState,
				property)));
		stateTextBoxField.clear();
		stateTextBoxField.sendKeys(state);
		return this;
	...
	public Address setCityName(String city) {
		cityTextField = driver.findElement(By.name(String.format(
				cityNameExpression, property)));
		cityTextField.clear();
		cityTextField.sendKeys(city);
		return this;
	...
	public Address setOtherCountry(String country) {
		countryTextField = driver.findElement(By.id(String.format(
				countryOtherTextExp, property)));
		countryTextField.sendKeys(country);
		return this;
	}

	public Address setOtherCountryValues(String country) {
		countryTextField = driver.findElement(By.id(String.format(
				countryOtherTextExpression, property)));
		countryTextField.sendKeys(country);
		return this;
	}
	...
	public Address setCityLivedAdjustmentOfStatus(String city) {
		cityEnteredField = driver.findElement(By.id(String.format(
				adjustmentOfStatusCity, property)));
		cityEnteredField.clear();
		cityEnteredField.sendKeys(city);
		return this;
	}

	public Address setUSCISOfficeCity(String city) {
		WebElement uscisOfficeField = driver.findElement(By.id(String.format(
				uscisOfficeCity, property)));
		Select uscisOfficeSelect = new Select(uscisOfficeField);
		uscisOfficeSelect.selectByValue(city);
		return this;
	}

	public Address setImmigrantCity(String city) {
		cityEnteredField = driver.findElement(By.id(String.format(
				immigrantCity, property)));
		cityEnteredField.clear();
		cityEnteredField.sendKeys(city);
		return this;
	}

	public Address setConsulateCity(String city) {
		cityEnteredField = driver.findElement(By.id(String.format(
				visaIssuedCity, property)));
		Select consulateCitySelect = new Select(cityEnteredField);
		consulateCitySelect.selectByValue(city);
		return this;
	}

	public Address setDestinationCity(String city) {
		cityField = driver.findElement(By.id(String.format(destinationCity,
				property)));
		Select targetCitySelect = new Select(cityField);
		targetCitySelect.selectByValue(city);
		return this;
	}

	public Address setPortOfEntryCity(String city) {
		cityField = driver.findElement(By.id(String.format(portOfEntryCity,
				property)));
		Select portCitySelect = new Select(cityField);
		portCitySelect.selectByValue(city);
		return this;
	}

	public Address setAddress(String appname, String elementProperty,
			String country) {

		Properties data = propertyFile.loadProperty(appname);

		Address residenceAddress = new Address(driver, "applicationData-"
				+ elementProperty);
		if (country.equalsIgnoreCase("USA")) {
			residenceAddress.setCountryField(data.getProperty(elementProperty
					+ ".countryUSA"));
			residenceAddress.setApartmentTypeAndNumber(
					data.getProperty(elementProperty + ".aptName"),
					data.getProperty(elementProperty + ".aptNum"));
			residenceAddress.setState(data.getProperty(elementProperty
					+ ".state" + country));
		...
		residenceAddress.setStreet(data.getProperty(elementProperty
				+ ".streetName"));
		residenceAddress.setCity(data.getProperty(elementProperty + ".city"));
		residenceAddress.setZipcode(data.getProperty(elementProperty
				+ ".zipcode"));
	...
	public Address setAddress(String appname, String elementProperty,
			String country, String aptInfoRequired, String addressType) {
		...
		Address residenceAddress = new Address(driver, "applicationData-"
				+ elementProperty);
		residenceAddress.setCountryField(data.getProperty(elementProperty
				+ ".country" + country + "." + addressType));

		if (country.equalsIgnoreCase("USA")) {
			if (aptInfoRequired.equalsIgnoreCase("Yes")) {
				residenceAddress.setApartmentTypeAndNumber(
						data.getProperty(elementProperty + ".aptName"),
						data.getProperty(elementProperty + ".aptNum"));
			}
			...
			if (country.equalsIgnoreCase("Other")) {
				residenceAddress.setOtherCountry(country);
			}
			residenceAddress.setStateText(data.getProperty(elementProperty
					+ ".state." + country + "." + addressType));
		}

		residenceAddress.setStreet(data.getProperty(elementProperty
				+ ".street." + country + "." + addressType));
		residenceAddress.setCity(data.getProperty(elementProperty + ".city."
				+ country + "." + addressType));
		residenceAddress.setZipcode(data.getProperty(elementProperty
	...
	public Address setAddressWithoutCountry(String appname,

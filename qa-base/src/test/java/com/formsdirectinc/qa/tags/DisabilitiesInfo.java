...
public class DisabilitiesInfo extends BaseTag {
	...
	public DisabilitiesInfo setSightDisability(String sightDisability) {
		disablityInfo = driver.findElement(By.id(String.format(
				sightDisabilityExpression, property)));
	...
	public DisabilitiesInfo setHearingImpaired(String hearingImpaired) {
		disablityInfo = driver.findElement(By.id(String.format(
				hearingImpairedExpression, property)));
	...
	public DisabilitiesInfo setOtherDisability(String otherDisability) {
		disablityInfo = driver.findElement(By.id(String.format(
				otherDisabilityExpression, property)));
		disablityInfo.sendKeys(otherDisability);
		return this;
	}

	public DisabilitiesInfo setSightDisabilityAccomodation(
			String sightDisability) {
		disablityInfo = driver.findElement(By.id(String.format(
				sightDisabilityExpression1, property)));
		disablityInfo.sendKeys(sightDisability);
		return this;
	}

	public DisabilitiesInfo setHearingImpairedAccomodation(
			String hearingImpaired) {
		disablityInfo = driver.findElement(By.id(String.format(
				hearingImpairedExpression1, property)));
		disablityInfo.sendKeys(hearingImpaired);
		return this;
	}

	public DisabilitiesInfo setOtherDisabilityAccomodation(
			String otherDisability) {
		disablityInfo = driver.findElement(By.id(String.format(
				otherDisabilityExpression1, property)));
		disablityInfo.sendKeys(otherDisability);
		return this;
	}

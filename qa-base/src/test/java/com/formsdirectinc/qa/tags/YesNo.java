...
/**
 * YesNo: Selenium page model for YesNo tag Author: <a
 * href="mailto:hari@dcis.net">Hari Selvarajan</a> Date: 6/21/15 4:18 PM
 * 
...
public class YesNo extends BaseTag {
	...
	public YesNo setExplaination(String explainWhy) {
		explainTextArea = driver.findElement(By.id(String.format(
				expainExpression, property)));

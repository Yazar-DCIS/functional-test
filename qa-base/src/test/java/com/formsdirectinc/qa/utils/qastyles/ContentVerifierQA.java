package com.formsdirectinc.qa.utils.qastyles;
...
public class ContentVerifierQA extends WizardPage {

	private By byPage = By.cssSelector("input[name='page']");
	private By byPageHeader = By.cssSelector("div[class='SubHeader-product']");
	private By byEQPageHeader = By
			.cssSelector("div[class='EqSubHeader-label']");
	private By byQuestionTitle = By.cssSelector("div[class='Question-title']");
	private By byQuestionInstruction = By
	...
	private By byFieldError = By
			.cssSelector("p[class='AnswerField-error error']");

	public ContentVerifierQA(WebDriver driver) {
		super(driver);
	...
	public void questionTitleWithID(String expectedQuestionTitle,
			String sectionID) {

		WebElement QuestionSection = driver.findElement(By
				.cssSelector("div[id='" + sectionID + "']"));

		QuestionSection = QuestionSection.findElement(By
				.cssSelector("div[class='Question-title']"));

		String actualquestionTitleLabel = QuestionSection.getText();
	...
	public void verifyContent(String expectedQuestionTitle, String sectionID,
			String contentID) {
		try {
			WebElement QuestionSection = driver.findElement(By
					.cssSelector("div[id='" + sectionID + "']"));
			...
			Reporter.log("Error while trying to verify Content: " + e);
		}
	...
	public void verifyFieldErrorMessage(String[] expectedError) {
		...
		for (int i = 0; i < numberOfFields; i++) {
			...
			writeAssertResults(actualFieldErrors[i], expectedError[i],
					"Field-Error-" + i);
		}
	...
	public ContentVerifierQA writeAssertResults(String actual, String expected,
			String type) {

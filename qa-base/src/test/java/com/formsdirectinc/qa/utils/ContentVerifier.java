...
/**
 * ContentVerifier: Base class for all copies
 * 
...
public class ContentVerifier extends WizardPage {
	...
	public ContentVerifier(WebDriver driver) {
		super(driver);
	...
	public ContentVerifier verifyPageLabelText(String expectedLabelText,
			String property) {
	...
	public ContentVerifier verifyMultipleLabelText(String expectedLabelText,
			String property, int labelCount) {
	...
	public ContentVerifier verifySubLabelsText(String expectedSubLabelText,
			String property, int subLabelCount) {
	...
	/* Method to verify multiple sub-labels in a Page */
	public ContentVerifier verifySubLabelsSpanText(String expectedSubLabelText,
			String property, int subLabelCount) {
	...
	public ContentVerifier verifyLearnMoreText(String expectedLearnMore) {
	...
	public ContentVerifier verifyFAQText(String expectedFAQ,
	...
	public ContentVerifier verifyExplainThisText(String expectedExplainThis,
			String property, String explainID) {
	...
	public ContentVerifier verifyMultipleExplainText(
	...
	public ContentVerifier verifyPageSectionHeader(
	...
	/* Method to verify the section header content in the Page */
	public ContentVerifier verifyPageMultiSectionHeader(
	...
	public ContentVerifier verifyPageTableHeader(String expectedPageTableHeader) {
	...
	public ContentVerifier verifyPageInstructionalText(
	...
	public ContentVerifier verifyContactUsText(String expectedContact_US) {
	...
	public ContentVerifier verifyResources_FAQContent(String expectedResources,
			String expectedFAQ, String expectedFAQAnswer) {
	...
	public ContentVerifier verifySorryPageText(String expectedContent,
			String property) {
	...
	public ContentVerifier writeAssertResults(String actual, String expected,
			String type) {
